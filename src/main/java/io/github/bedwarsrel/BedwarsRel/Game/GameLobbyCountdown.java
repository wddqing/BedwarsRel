...
public class GameLobbyCountdown extends BukkitRunnable {
    ...
    public void run() {
        ...
        if (this.counter > this.lobbytimeWhenFull
            ...
            this.game
                    .broadcast(ChatColor.YELLOW + Main._l("lobby.countdown", ImmutableMap.of("sec",
                            ChatColor.RED.toString() + this.counter + ChatColor.YELLOW)), players);
        }
        ...
        if (this.counter == this.lobbytime) {
            this.game
                    .broadcast(
                            ChatColor.YELLOW + Main._l("lobby.countdown", ImmutableMap.of("sec",
                                    ChatColor.RED.toString() + this.counter + ChatColor.YELLOW)), players);
